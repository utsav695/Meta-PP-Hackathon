...
namespace Broccoli.Examples 
{
    ...
    public class ModifyPipelineEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            // Randomize Trunk curve.
            EditorGUILayout.LabelField ("StructureGenerator modifiers:");
            if (GUILayout.Button ("Randomize Trunk Length")) {
                modifyPipelineController.RandomizeTrunkLength ();
            }
            if (GUILayout.Button ("Randomize Trunk Curve")) {
                modifyPipelineController.RandomizeTrunkCurve ();
            }
