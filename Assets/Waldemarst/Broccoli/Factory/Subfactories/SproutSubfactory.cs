    ...
    public class SproutSubfactory {
        ...
        public void SnapshotCollectionToPipeline () {
            ...
            if (branchBenderElement) {
                branchBenderElement.noiseType = BranchBenderElement.NoiseType.Basic;
            ...
            if (sproutMapperElement != null) {
                sproutMapperElement.sproutMaps [0].alphaCutoff = 0f;
                ...
                sproutMapperElement.sproutMaps [0].shadeMode =
                    (SproutMap.ShadeMode)branchDescriptorCollection.sproutStyleA.sproutShadeMode;
                sproutMapperElement.sproutMaps [0].shadeVariance = branchDescriptorCollection.sproutStyleA.sproutShadeVariance;
                sproutMapperElement.sproutMaps [0].invertShadeMode = branchDescriptorCollection.sproutStyleA.invertSproutShadeMode;
                if (Broccoli.Base.GlobalSettings.experimentalSproutLabDissolveSprouts) {
                    sproutMapperElement.sproutMaps [0].alphaVarianceMode = SproutMap.AlphaVarianceMode.Dissolve;
                    sproutMapperElement.sproutMaps [0].minColorDissolve = branchDescriptorCollection.sproutStyleA.minColorDissolve;
                    sproutMapperElement.sproutMaps [0].maxColorDissolve = branchDescriptorCollection.sproutStyleA.maxColorDissolve;
                    sproutMapperElement.sproutMaps [0].dissolveMode =
                        (SproutMap.DissolveMode)branchDescriptorCollection.sproutStyleA.sproutDissolveMode;
                    sproutMapperElement.sproutMaps [0].dissolveVariance = branchDescriptorCollection.sproutStyleA.sproutDissolveVariance;
                    sproutMapperElement.sproutMaps [0].invertDissolveMode = branchDescriptorCollection.sproutStyleA.invertSproutDissolveMode;
                } else {
                    sproutMapperElement.sproutMaps [0].alphaVarianceMode = SproutMap.AlphaVarianceMode.None;
                }
                ...
                sproutMapperElement.sproutMaps [0].subsurfaceColor = GetSubsurfaceColor (branchDescriptorCollection.sproutStyleA.subsurface);
            ...
            if (sproutMapperElement != null && sproutMapperElement.sproutMaps.Count > 1) {
                sproutMapperElement.sproutMaps [1].alphaCutoff = 0f;
                ...
                sproutMapperElement.sproutMaps [1].shadeMode =
                    (SproutMap.ShadeMode)branchDescriptorCollection.sproutStyleB.sproutShadeMode;
                sproutMapperElement.sproutMaps [1].shadeVariance = branchDescriptorCollection.sproutStyleB.sproutShadeVariance;
                sproutMapperElement.sproutMaps [1].invertShadeMode = branchDescriptorCollection.sproutStyleB.invertSproutShadeMode;
                if (Broccoli.Base.GlobalSettings.experimentalSproutLabDissolveSprouts) {
                    sproutMapperElement.sproutMaps [1].alphaVarianceMode = SproutMap.AlphaVarianceMode.Dissolve;
                    sproutMapperElement.sproutMaps [1].minColorDissolve = branchDescriptorCollection.sproutStyleB.minColorDissolve;
                    sproutMapperElement.sproutMaps [1].maxColorDissolve = branchDescriptorCollection.sproutStyleB.maxColorDissolve;
                    sproutMapperElement.sproutMaps [1].dissolveMode =
                        (SproutMap.DissolveMode)branchDescriptorCollection.sproutStyleB.sproutDissolveMode;
                    sproutMapperElement.sproutMaps [1].dissolveVariance = branchDescriptorCollection.sproutStyleB.sproutDissolveVariance;
                    sproutMapperElement.sproutMaps [1].invertDissolveMode = branchDescriptorCollection.sproutStyleB.invertSproutDissolveMode;
                } else {
                    sproutMapperElement.sproutMaps [1].alphaVarianceMode = SproutMap.AlphaVarianceMode.None;
                }
            ...
            if (snapshotSettings.hasCrown && sproutMeshes.Count > 2) {
                ...
                if (sproutMapperElement != null && sproutMapperElement.sproutMaps.Count > 2) {
                    sproutMapperElement.sproutMaps [2].alphaCutoff = 0f;
                    ...
                    sproutMapperElement.sproutMaps [2].shadeMode =
                        (SproutMap.ShadeMode)branchDescriptorCollection.sproutStyleCrown.sproutShadeMode;
                    sproutMapperElement.sproutMaps [2].shadeVariance = branchDescriptorCollection.sproutStyleCrown.sproutShadeVariance;
                    sproutMapperElement.sproutMaps [2].invertShadeMode = branchDescriptorCollection.sproutStyleCrown.invertSproutShadeMode;
                    if (Broccoli.Base.GlobalSettings.experimentalSproutLabDissolveSprouts) {
                        sproutMapperElement.sproutMaps [2].alphaVarianceMode = SproutMap.AlphaVarianceMode.Dissolve;
                        sproutMapperElement.sproutMaps [2].minColorDissolve = branchDescriptorCollection.sproutStyleCrown.minColorDissolve;
                        sproutMapperElement.sproutMaps [2].maxColorDissolve = branchDescriptorCollection.sproutStyleCrown.maxColorDissolve;
                        sproutMapperElement.sproutMaps [2].dissolveMode =
                            (SproutMap.DissolveMode)branchDescriptorCollection.sproutStyleCrown.sproutDissolveMode;
                        sproutMapperElement.sproutMaps [2].dissolveVariance = branchDescriptorCollection.sproutStyleCrown.sproutDissolveVariance;
                        sproutMapperElement.sproutMaps [2].invertDissolveMode = branchDescriptorCollection.sproutStyleCrown.invertSproutDissolveMode;
                    } else {
                        sproutMapperElement.sproutMaps [2].alphaVarianceMode = SproutMap.AlphaVarianceMode.None;
                    }
            ...
            string compositePath) 
        {
            ...
            if (branchDescriptorCollection.snapshots.Count == 0) {
                ...
                if ((branchDescriptorCollection.exportTexturesFlags & 1) == 1) {
                    ...
                    TexturePacker.PackTextures (out atlas, texturesForAtlas.ToArray (), TexturePacker.PackMode.ScaleEven, texPackParams);
            ...
            string compositePath) 
        {
            ...
            if (branchDescriptorCollection.snapshots.Count == 0) {
                ...
                if ((branchDescriptorCollection.exportTexturesFlags & 1) == 1) {
                    ...
                    atlasRects = TexturePacker.PackTextures (out atlas, texturesForAtlas.ToArray (), TexturePacker.PackMode.ScaleEven, texPackParams);
                    atlas.alphaIsTransparency = true;
                ...
                if (compositeMaterials [i] != null) {
                    ...
                    if (i >= materialAStartIndex) {
                        if (i >= materialCrownStartIndex && materialCrownStartIndex >= 0) {
                            ...
                            m.SetColor ("_SubsurfaceColor", GetSubsurfaceColor (styleCrown.subsurface));
                            ...
                            m.SetColor ("_SubsurfaceColor", GetSubsurfaceColor (styleB.subsurface));
                            ...
                            m.SetColor ("_SubsurfaceColor", GetSubsurfaceColor (styleA.subsurface));
                        }
                    }
                }
            }
