	...
	public class TrunkMeshGeneratorComponent : TreeFactoryComponent {
		...
		public override bool Process (TreeFactory treeFactory, 
			...
			if (pipelineElement != null && treeFactory != null) {
				...
				IBranchMeshBuilder bmb = branchMeshBuilder.GetBranchMeshBuilder (BranchMeshBuilder.BuilderType.Trunk);
				if (!(bmb is Broccoli.Builder.TrunkMeshBuilder)) return false;
				TrunkMeshBuilder trunkMeshBuilder = (TrunkMeshBuilder) bmb;
