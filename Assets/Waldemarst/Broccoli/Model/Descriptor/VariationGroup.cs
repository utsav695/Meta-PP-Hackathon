...
namespace Broccoli.Pipe {
    ...
    public class VariationGroup {
        ...
        /// <summary>
        /// Controls if this Variation Group will produce a mesh at a given LOD.
        /// For example: when maxActiveLOD=2, this Variation Group will produce a mesh at LOD0, LOD1 and LOD2.
        /// when maxActiveLOD=1, this Variation Group will produce a mesh at LOD0 and LOD1.
        /// when maxActiveLOD=0, this Variation Group will produce a mesh only at LOD0.
        /// </summary>
        public int maxActiveLOD = 2;
        /// <summary>
        /// The ids of the snapshots use by this groupd to get the meshes from.
        /// </summary>
        public List<int> snapshotIds = new List<int> (); 
        /// <summary>
        /// Mask values per snapshot used by this group, containing the LODs allowed
        /// to be used.
        /// </summary>
        ...
        public VariationGroup Clone () {
            ...
            clone.maxActiveLOD = maxActiveLOD;
