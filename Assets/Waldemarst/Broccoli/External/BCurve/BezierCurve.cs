...
namespace Broccoli.Model
{
	...
	public class BezierCurve : ISerializationCallbackReceiver {
		...
		/// <summary>
		/// Sets the noise based on a Fast Noise Lite instance.
		/// </summary>
		/// <param name="noise"></param>
		/// <param name="noiseLengthOffset"></param>
		public void SetNoise (FastNoiseLite noise, float noiseLengthOffset = 0f) {
			this.noise = noise;
		}
		[Obsolete ("This method has been deprecated for Broccoli 1.9.7, please update the extension consuming it.", false)]
		...
		{
			SetNoise (noiseFactorAtFirstNode, 
