...
namespace Broccoli.RectpackSharp
{
    /// <summary>
    ...
    public static class RectanglePacker
    {
            ...
            uint? maxBoundsWidth = null, uint? maxBoundsHeight = null)
        {
            ...
            #else
            PackingHints[] hints = new PackingHints[PackingHintExtensions.MaxHintCount];
            #endif
            ...
            #else
            uint rectanglesAreaSum = CalculateTotalArea(ref rectangles);
            #endif
            ...
            ref PackingRectangle[] tmpArray, uint binWidth, uint binHeight, uint stepSize, uint acceptableArea, out PackingRectangle bounds)
        {
            ...
            #else
            while ((isFirst || boundsWidth * boundsHeight > acceptableArea) &&
                    TryPackAsOrdered(emptySpaces, ref rectangles, ref tmpArray, binWidth, binHeight, out boundsWidth, out boundsHeight))
            #endif
            {
        ...
        #if UNITY_2022_1_OR_NEWER
        private static bool TryPackAsOrdered(List<PackingRectangle> emptySpaces, Span<PackingRectangle> unpacked, Span<PackingRectangle> packed, uint binWidth, uint binHeight, out uint boundsWidth, out uint boundsHeight)
        #else
        private static bool TryPackAsOrdered(List<PackingRectangle> emptySpaces, ref PackingRectangle[] unpacked, ref PackingRectangle[] packed, uint binWidth, uint binHeight, out uint boundsWidth, out uint boundsHeight)
        #endif
        {
        ...
        #else
        public static uint CalculateTotalArea(ref PackingRectangle[] rectangles)
        #endif
        {
            uint totalArea = 0;
        ...
        #else
        public static PackingRectangle FindBounds(ref PackingRectangle[] rectangles)
        #endif
        {
        ...
        #else
        public static bool AnyIntersects(ref PackingRectangle[] rectangles)
        #endif
        {
            for (int i = 0; i < rectangles.Length; i++)
