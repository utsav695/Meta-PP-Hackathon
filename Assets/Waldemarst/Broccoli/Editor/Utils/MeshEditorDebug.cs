...
namespace Broccoli.BroccoEditor {
    ...
    public class MeshEditorDebug {
            ...
            bool exportToScene = false) 
        {
			...
			_mesh = Mesh.Instantiate(_sproutLabEditor.sproutSubfactory.sproutCompositeManager.GetSnapshotMesh (_sproutLabEditor.selectedSnapshot.id, lodIndex, resolution));
            _snapshotMesh = Mesh.Instantiate(_mesh);
        ...
        private void DebugAddBranchCollection () {
			Mesh mesh = 
                Broccoli.Builder.BranchCollectionSproutMeshBuilder.GetSnapshotMesh (
