...
namespace Broccoli.Pipe {
	...
	public class BranchMeshGeneratorElement : PipelineElement {
		...
		/// <summary>
		/// Minimum resolution steps per length unit to apply to branches.
		/// </summary>
		public float minCurveStepsPerUnit = 12f;
		/// <summary>
		/// Maximum resolution steps per length unit to apply to branches.
		/// </summary>
		public float maxCurveStepsPerUnit = 20f;
		#endregion
		...
		override public PipelineElement Clone (bool isDuplicate = false) {
			...
			clone.minCurveStepsPerUnit = minCurveStepsPerUnit;
			clone.maxCurveStepsPerUnit = maxCurveStepsPerUnit;
